...
!
 PARAMETER(NPERIOD=80000,NTOT=8,R0=60.1d-9, &
           !Vienna cavity &bead parameters
 !   PARAMETER(NPERIOD=160000,NTOT=8,R0=71.5d-9, &
!              rho=2198.d0,EPSR=1.45d0**2,Epsi0=8.854d-12, &
            rho=1850.d0,EPSR=1.98d0,Epsi0=8.854d-12, &
    c=3.d8,hbar=1.05d-34,BOLTZ=1.4d-23,TEMP=300.d0,Gravity=9.8d0,&
    WK=5.9d6,waist=61.d-6,WX=1.043d-6,Wy=0.9035d-6,XL=1.223d-2,Finesse=3.d4, &
    Press=3.e-3,Pin1=0.44d0,DET1=-176.d3,DelFSR=14.d9,theta0=0.25d0,& 
